    ...
    <div className="w-52 z-10 fixed inset-y-0 bg-dashboard  ">
      <div className="p-6">
        ...
        <div>
          ...
          <div className="dashboard_item">
            <Link href="/vendor" className="dashboard_text flex gap-6">
              <IconSquareLetterV className=" w-6 h-6" />
              Vendors
            </Link>
          </div>
          <div className="dashboard_item">
            <Link href="/service" className="dashboard_text flex gap-6">
              <IconArrowLoopRight2 className=" w-6 h-6" />
              Services
            </Link>
          </div>
          <div className="dashboard_item">
            <Link href="/booking" className="dashboard_text flex gap-6">
              <IconSquareLetterB className=" w-6 h-6" />
              Booking
            </Link>
          </div>
          <div className="dashboard_item">
            <Link href="/payment" className="dashboard_text flex gap-6">
